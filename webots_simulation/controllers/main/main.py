...
from ex1_pid_control import quadrotor_controller
from ex2_kalman_filter import kalman_filter as KF
from ex3_motion_planner import MotionPlanner3D as MP
import my_assignment as assignment
import ex0_rotations as ex0_rotations
...
# # Add a fixed seed here to make the randomized world deterministic
# SEED = 127 # 987654321 # 42; 12 edge case close to edge; 127 outer edge case
...
class CrazyflieInDroneDome(Supervisor):
    def __init__(self):
        ...
        self.PID_CF = quadrotor_controller(exp_num=4)
        ...
        # Course parameters
        self.circle_centre = [2.025, 1.435]
