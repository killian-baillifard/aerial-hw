...
class Setpoint:
    ...
    def to_command(self, measurement: "Measurement") -> Command:
        ...
        vx = relative_error.x if relative_error.x < Setpoint.MAX_EQUIV_CMD_VELOCITY else Setpoint.MAX_EQUIV_CMD_VELOCITY
        vy = relative_error.y if relative_error.y < Setpoint.MAX_EQUIV_CMD_VELOCITY else Setpoint.MAX_EQUIV_CMD_VELOCITY
        vz = relative_error.z if relative_error.z < Setpoint.MAX_EQUIV_CMD_VELOCITY else Setpoint.MAX_EQUIV_CMD_VELOCITY
