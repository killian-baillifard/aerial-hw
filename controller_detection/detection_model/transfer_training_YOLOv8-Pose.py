...
def train_gate_pose_model():
    ...
    results = model.train(
        data='dataset/annotated_gates_v5bw_split/data.yaml',
        ...
        device='0',                 # Use '0' for GPU, or 'cpu' if you don't have a dedicated GPU, 'mps' for Apple Silicon
        ...
        name='yolov8n_v5bw_ontopv2rgb2_r1',     # Subfolder for this specific training run
